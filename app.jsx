...
const MOODS = {
  ...
  clinical: {
    ...
    ctaText: "#fff",
    shellShadow:
      "0 40px 80px rgba(15,30,60,0.16), 0 0 0 1px rgba(13,23,38,0.10)",
  },
};
...
const GmailIcon = ({ size = 38 }) => (
  ...
  >
    ...
    <g transform="translate(7 12)">
      <path
        d="M3 24V8.5L17 18 31 8.5V24a2 2 0 0 1-2 2h-3V13.5L17 20 8 13.5V26H5a2 2 0 0 1-2-2Z"
        fill="#4285F4"
      />
      <path d="M3 8.5V24a2 2 0 0 0 2 2h3V13.5L3 8.5Z" fill="#34A853" />
      <path d="M31 8.5V24a2 2 0 0 1-2 2h-3V13.5L31 8.5Z" fill="#FBBC04" />
      <path
        d="M3 6.2C3 4.4 5.1 3.4 6.5 4.5L17 12.4 27.5 4.5C28.9 3.4 31 4.4 31 6.2V8.5L17 18 3 8.5V6.2Z"
        fill="#EA4335"
      />
    </g>
  </svg>
...
function LockScreen({
    ...
    default: [
      {
        ...
        type: "gmail",
        sender: "Cochlear",
        subject: "It's time to complete your Remote Check",
        time: "now",
      },
      {
        id: 1,
        text: "It's time to complete your Remote Check",
        app: "Cochlear",
      },
      {
        id: 2,
        text: "Have you recently replaced your Microphone protectors?",
        app: "Cochlear",
      },
    ],
    reviewed: [
      {
        ...
        type: "gmail",
        sender: "Cochlear",
        subject: "Your clinician has reviewed your Remote Check",
        time: "now",
      },
      {
        id: 1,
        text: "Your clinician has reviewed your Remote Check",
        app: "Cochlear",
        route: "review",
      },
    ],
  ...
  const notifications = notificationSets[variant] || notificationSets.default;

  const visible = notifications.filter((n) => !dismissed.has(n.id));

  const animateAndOpen = (route) => {
    onStartUnlock?.();
    setLiftY(-1000);
    setTimeout(() => onOpenApp(route), 320);
  };
  ...
  return (
    <div
      style={{
        ...
        backgroundImage: "url(lock-screen-background.png)",
          ...
          >
            {visible.map((notif) => (
              <LockNotification
                ...
                notif={notif}
                accent={accent[0]}
                onTap={() => animateAndOpen(notif.route)}
    ...
    >
      <div
        style={{
          ...
          padding: "14px 16px",
          boxShadow:
            "0 8px 24px rgba(0,0,0,0.3), 0 0 0 0.5px rgba(255,255,255,0.1)",
        }}
      >
        {notif.type === "gmail" ? (
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <p style={{ margin: 0, fontSize: 14, lineHeight: 1.35 }}>
                {notif.text}
              </p>
            </div>
          </div>
    ...
    >
      ...
      {backdrop === "wash" && (
        ...
        >
          ...
          <path
            d="M 420 -20 L 420 470 C 380 480, 350 440, 310 415 C 265 388, 220 425, 185 470 C 150 515, 105 560, 55 575 C 25 583, 0 580, -20 580 L -20 0 C 30 -10, 80 -15, 140 -18 C 220 -22, 320 -20, 420 -20 Z"
            fill="url(#washGrad)"
            opacity={mood === "midnight" ? 0.75 : 1}
          />
        </svg>
      )}
      {backdrop === "quiet" && (
...
function Flyout({ open, onClose, mood, accent }) {
  ...
  const items3 = [{ icon: "restart_alt", label: "Reset to Defaults" }];
...
const Divider = ({ color }) => (
  <div style={{ height: 1, background: color, margin: "12px 24px" }} />
);
...
function Notifications({ mood, accent, onOpenRemoteCheck }) {
  ...
  const notifications = [
    {
      ...
      text: "It's time to complete your Remote Check",
      action: onOpenRemoteCheck,
    },
    {
      id: 2,
      subject: "Hearing Health",
      text: "Have you recently replaced your Microphone protectors?",
    },
  ];
  ...
  return (
    <div
      style={{
        position: "absolute",
        top: "calc(var(--statusbar-h, 54px) + 60px)",
        left: 16,
        right: 16,
        zIndex: 10,
        display: "flex",
    ...
    >
      {notifications.map((notif) => (
        <div
          key={notif.id}
          onClick={() => notif.action && notif.action()}
          style={{
            background:
              mood === "midnight"
                ? "rgba(45,42,38,0.95)"
    ...
    >
      <div style={{ flex: 1, position: "relative", overflow: "hidden" }}>
        ...
        <Notifications
          mood={mood}
          accent={accent}
          onOpenRemoteCheck={onOpenRemoteCheck}
        />
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <BatteryFull
              size={26}
              color={mood === "midnight" ? "#7cd185" : "#1f7a3a"}
            />
            <StatusOK
              size={28}
              ringColor={mood === "midnight" ? "#48c057" : "#3aaf3f"}
            />
          </div>
        </div>
      </div>
...
const RowDivider = ({ color }) => (
  <div style={{ height: 1, background: color, margin: "0 24px" }} />
);
const RowLabel = ({ children, color }) => (
  <span style={{ fontSize: 18, fontWeight: 500, color, letterSpacing: 0.1 }}>
    {children}
  </span>
);
  ...
  return (
    ...
    >
      <svg width="42" height="42" viewBox="0 0 42 42">
        <path
          d="M11 7 H33 A4 4 0 0 1 37 11 V27 A4 4 0 0 1 33 31 H22 L15 36.5 V31 H11 A4 4 0 0 1 7 27 V11 A4 4 0 0 1 11 7 Z"
          fill="none"
          stroke={stroke}
          strokeWidth="2"
          strokeLinejoin="round"
...
function AudioSourcesGlyph({ stroke, accent }) {
  return (
    <svg width="48" height="40" viewBox="0 0 48 40">
      <path
        d="M22 4 C13 4 8 11 8 19 C8 25 11 28 13 30 C15 32 16 33 16 35 C16 37 17 38 19 38 C22 38 23 35 23 33 C23 30 21 28 21 25 C21 23 22 22 24 22 C27 22 29 20 29 17 C29 14 27 12 24 12 C22 12 21 13 21 14 C21 16 23 16 23 15"
        fill="none"
        stroke={stroke}
        strokeWidth="2"
        strokeLinecap="round"
  ...
  return (
    <TweaksPanel>
      ...
      <TweakRadio
        label="Surface"
        value={t.mood}
        options={["daylight", "midnight", "clinical"]}
...
function LaunchOverlay({ phase }) {
  ...
  if (phase === "start") {
    ...
    style = {
      ...
      opacity: 1,
      transition:
        "left 400ms cubic-bezier(0.4,0,0.2,1), top 400ms cubic-bezier(0.4,0,0.2,1), width 400ms cubic-bezier(0.4,0,0.2,1), height 400ms cubic-bezier(0.4,0,0.2,1), border-radius 400ms ease",
    };
  } else {
    // fade
    style = {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "#2a2521" }}>
      ...
      <Hotspot
        label="Back"
        onClick={onBack}
        style={{ left: "1%", top: "6%", width: "15%", height: "6%" }}
      />
      <Hotspot
        label="Get started"
        onClick={onStart}
...
function RemoteCheckProgress({ onBack, onShowLock }) {
  return (
    <div
      onClick={onShowLock}
      style={{
...
// ─── Remote Check — review results screen ─────────────────────
function RemoteCheckReview({ onBack }) {
  return (
    <div style={{ position: "absolute", inset: 0, background: "#fff" }}>
      <div
        style={{
          position: "absolute",
          inset: 0,
          backgroundImage: "url(remote-check-review.png)",
          backgroundSize: "cover",
          backgroundPosition: "center top",
          backgroundRepeat: "no-repeat",
        }}
...
function AppScreens({
  ...
  const go = (to, dir) => {
    setAnim(
      dir === "forward"
        ? { base: view, moving: to, dir }
        : { base: to, moving: view, dir },
    );
    setView(to);
  ...
  const renderView = (name) => {
    ...
    if (name === "remotecheck") {
      return (
        <RemoteCheckStart
          onBack={() => go("dashboard", "back")}
          onStart={() => go("progress", "forward")}
        />
      );
    }
    if (name === "progress") {
      return (
        <RemoteCheckProgress
          onBack={() => go("remotecheck", "back")}
          onShowLock={onShowLock}
        />
      );
    }
    if (name === "review") {
      return <RemoteCheckReview onBack={() => go("dashboard", "back")} />;
    }
    return null;
  };
...
function App() {
  ...
  const [lockVariant, setLockVariant] = useState("default"); // 'default' | 'reviewed'
  ...
  const launchApp = () => {
    ...
    requestAnimationFrame(() =>
      requestAnimationFrame(() => setLaunch("expand")),
    );
  ...
  const content =
    screen === "app" ? (
      <AppScreens
        ...
        onShowLock={handleShowLock}
        initialView={initialAppView}
      />
    ) : (
      <>
        {/* Base layer: white when unlocking to notification route, otherwise iOS home screen */}
        {unlocking ? (
          <div style={{ position: "absolute", inset: 0, background: "#fff" }} />
        ) : (
        ...
        {screen === "lock" && (
          <LockScreen
            onStartUnlock={() => setUnlocking(true)}
            onOpenApp={(route) => {
              setUnlocking(false);
              if (route) {
                setInitialAppView(route);
                setLaunch("expand");
                setScreen("app");
                setTimeout(() => setLaunch("fade"), 800);
                setTimeout(() => setLaunch(null), 1200);
              } else {
                setInitialAppView("dashboard");
                setScreen("app");
              }
            }}
            onDismiss={() => {
